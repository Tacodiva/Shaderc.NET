...
namespace Shaderc;
public enum ShaderTargetEnvironment : byte {
    /// <summary>
...
/// </remarks>
public enum ShaderEnvironmentVersion : UInt32 {
    Vulkan_1_0 = ((1u << 22)),
...
public enum ShaderCompilationStatus : byte {
    Success = 0,
...
public enum ShaderProfile : byte {
    None,
    Core,
    Compatibility,
    Es,
};
public enum ShaderOptimizationLevel : byte {
    Zero,
    Size,
    Performance,
};
public enum ShaderLimit : byte {
    MaxLights,
    MaxClipPlanes,
    MaxTextureUnits,
    MaxTextureCoords,
...
public enum ShaderUniformKind : byte {
    Image,
    Sampler,
    Texture,
    Buffer,
...
/// An include result.
/// </summary>
public struct ShaderIncludeResult {
    ...
    internal ShaderIncludeResult(string sourceName, string content, int optionsId) {
